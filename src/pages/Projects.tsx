          ...
          {projectsPage.map(([project1, project2]) => (
            <div className="">
              <div className="grid grid-cols-1 lg:grid-cols-2 h-full p-2 gap-2">
                <Slide left>
                  <div className="rounded-2xl relative overflow-hidden flex justify-center items-center group shadow-lg hover:shadow-pink-500/30 transition-all duration-500">
                    <div className="flex items-center justify-center relative overflow-hidden">
                      ...
                      />
                      <div className="absolute inset-0 bg-gradient-to-br from-pink-900/70 via-purple-900/80 to-pink-800/70 opacity-0 group-hover:opacity-90 transition-all duration-700"></div>
                        ...
                        <div className="w-full flex justify-center items-center flex-col ">
                          ...
                          <div className="flex gap-3 md:my-3">
                            {project1.languages.map((item, index) => (
                              <div className="bg-gradient-to-br from-pink-400/50 to-purple-500/50 p-2 rounded-full text-[20px] transform hover:scale-[1.2] transition-all duration-300 cursor-pointer shadow-lg hover:shadow-pink-400/50">
                                <svg
                                  stroke="white"
                                  fill="white"
                                  stroke-width="0"
                          ...
                          <div className="flex gap-4 h-[130px] mt-1 md:text-lg">
                            ...
                            <span
                              ...
                              onClick={() => {
                                open();
                                setActiveDot(0);
                                setSelectedImages(project1.images);
                              }}
                            >
                              <FaRegImages />
                            </span>
                          ...
                          <div className="flex gap-4 h-[130px] mt-1 md:text-lg">
                            ...
                            <span
                              ...
                              onClick={() => {
                                open();
                                setActiveDot(0);
                                setSelectedImages(project2.images);
                              }}
                            >
                              <FaRegImages />
                            </span>
